...
signal PC_tb, rs1_tb, rs2_tb, writeData_tb, IR_tb, immediate_tb, newAddress_tb : std_logic_vector(31 downto 0);
...
signal RAMen_tb, RAMwe_tb, REGwe_tb, jump_or_branch_flag_tb : std_logic;
begin
    ...
    dut: entity work.CPU32bit
        port map(
            ...
            reset => reset_tb,
				...
				RAMwe => RAMwe_tb,
				REGwe => REGwe_tb,
				jump_or_branch_flag => jump_or_branch_flag_tb,
				newAddress => newAddress_tb
        );
